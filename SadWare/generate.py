...
@@@@@@@@@@@@@ @@@@@@@@@\__@_/@@@@@
 @@@@@@@@@@@@@@@/,/,/./'/_|.\'\,\\
   @@@@@@@@@@@@@|  | | | | | | | |
        ver 1.0  \_|_|_|_|_|_|_|_|
    
 {green}SadWare - Simple Ransomware Generator 
 {green}by @Kavleri (Muhammad Hisyam Alfaris)

{yellow}({red}*{yellow}) Disclaimer!! {red} : This tool is for educational purposes only! I am not responsible for any harmful actions taken with this tool. Use responsibly!
